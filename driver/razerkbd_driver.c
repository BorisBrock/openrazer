...
static void razer_get_report_params(struct usb_device *usb_dev, uint *report_index, uint *response_index, ulong *wait_min, ulong *wait_max)
{
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIRED:
        *report_index = 0x03;
        *response_index = 0x03;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_X:
        ...
        *wait_max = RAZER_BLACKWIDOW_CHROMA_WAIT_MAX_US;
        break;
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIRELESS:
...
static void razer_kbd_disconnect(struct hid_device *hdev)
{
    ...
    if(intf->cur_altsetting->desc.bInterfaceProtocol == USB_INTERFACE_PROTOCOL_MOUSE) {
        ...
        case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIRED:
        case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIREDLESS:
            device_remove_file(&hdev->dev, &dev_attr_matrix_effect_wave);            // Wave effect
            device_remove_file(&hdev->dev, &dev_attr_matrix_effect_spectrum);        // Spectrum effect
            device_remove_file(&hdev->dev, &dev_attr_matrix_effect_starlight);       // Starlight effect
            device_remove_file(&hdev->dev, &dev_attr_matrix_effect_none);            // No effect
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIRELESS) },
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LP_TKL_HYPERSPEED_WIRED) },
    { 0 }
};
